...
#define M1 1      //DC motor
#define M2 2      //DC motor

#define L1 11      //DC motor
#define L2 12      //DC motor
...
if(matlabData == 5)	//Right button
  {
    Serial.print(matlabData);
    servo.write(105);	//Turning right
    startMotors();
    delay(2000);
