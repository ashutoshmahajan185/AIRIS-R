...
url = 'D:\BE Project\Semester 8\Image Classification\Dataset\Output\101_ObjectCategories.tar.gz';
% Store the output in a temporary folder
outputFolder = fullfile('D:\BE Project\Semester 8\Image Classification\Dataset\');
...
rootFolder = fullfile(outputFolder, 'Output');
...
url = '';
% Store the output in a temporary folder
outputFolder = fullfile('D:','BE Project','Semester 8','Image Classification','Dataset','Output'); % define output folder
